...
public class LogInfoAspect2 {
    ...
    public void doBefore(JoinPoint joinPoint) {
        System.out.println("AOP2------>前置方法执行");
    }
    ...
    public void doAfter(JoinPoint joinPoint) {
        System.out.println("AOP2------>后置通知执行");
    }
    ...
    public void doAfterThrowing(JoinPoint joinPoint) {
        System.out.println("AOP2------>异常通知执行");
    }
    ...
    public void after(JoinPoint joinPoint) throws RuntimeException {
        System.out.println("AOP2------>返回通知执行");
    }
}
